...
export const lightIndustryProducts = [
  ...
  {
    name: "РУКАВИЦЫ СПЕЦИАЛЬНЫЕ по ГОСТ 12.4.010-75*",
    description:
...
export const consumptionGoods = [
  {
    ...
    characteristics: [
      ...
      {
        name: "Допустимая длинна дров (мм)",
        id: "7",
        value: "от 550 до 800",
      },
      {
...
export const sidewalkTile = [
  {
    ...
    tableCharacteristics: [
      ...
      ["1м2 = 50,8 шт.", "П20.10.6-МВЦкр-аВ22,5 3%", "Красный (верх)"],
      ["1м2 = 0,0655 м3", "П20.10.6-МВЦч-аВ22,5 3%", "Черный (верх)"],
      [
        "Объем 1шт. = 0,0013 м3",
...
export const fittings = [
  {
    ...
    characteristics: [
      ...
      {
        name: "Сокращенное обозначение покрытия",
        id: "3",
